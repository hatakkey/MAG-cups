...
# Start UEs dynamically
docker exec -d cups-ue1 bin/bash -c "nr-ue -c ue.yaml -i 206010000000009 -n 10  > /opt/open5gs/var/log/open5gs/ue1.log"
...
docker exec -it cups-ue1 /bin/bash -c '
    while true; do
        ...
        if [[ "$all_ready" == true ]]; then
            ...
            # Add a new multipath route balancing over all uesimtunX interfaces
