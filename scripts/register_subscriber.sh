...
for i in $(seq -w 1 11); do
  ...
  docker exec -u root cups-dbctl open5gs-dbctl --db_uri=mongodb://mongo/open5gs add_ue_with_slice \
    $IMSI 465B5CE8B199B49FAA5F0A2EE238A6BD E8ED289DEBA952E4283B54E88E6183CB demo.nokia.mnc001.mcc206.gprs 1 abcdef
  echo "Added IMSI: $IMSI"
done

echo "All subscribers added successfully!"
